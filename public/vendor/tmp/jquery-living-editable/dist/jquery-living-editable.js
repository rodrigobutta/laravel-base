    ...
    EditableForm.prototype = {
        ...
        **/
        ...
        submit: function(e) {
            ...
            if (typeof this.options.preventSubmit === 'function') {

                var pk = this.getpk();

                var oldValue = this.value;

                this.options.preventSubmit.call(this.options.scope, this, pk, oldValue, newValue);
        ...
        initSaving: function(newValue){

            console.log('initSaving')
        ...
        getpk: function() {
            ...
            var res = (typeof this.options.pk === 'function') ? this.options.pk.call(this.options.scope) : this.options.pk;
        ...
        save: function(submitValue) {
            ...
            */
            var send = !!(typeof this.options.url === 'function' || (this.options.url && ((this.options.send === 'always') || (this.options.send === 'auto' && pk !== null && pk !== undefined))));
            var params;
...
(function ($) {
    ...
    Editable.prototype = {
        ...
        **/
        ...
        resumeSubmit: function(instance, newValue) {
            console.log('resumeSubmit')
            // console.log(newValue)
           instance.initSaving(newValue);
        },

        cancelSubmit: function(instance, message) {
             // console.log(error)
