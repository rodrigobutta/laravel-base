...
!function ($) {
    ...
    var calculateObjectValue = function (self, name, args, defaultValue) {
        ...
        // REB TODO fix para limpiar todo el editable de los valores de la tabla

        // if (typeof defaultValue === 'string') {

        //     // si no tiene un tag de A no hago nada
        //     if(defaultValue.indexOf("<a")>0){

        //         // como pueen venir valores como '0 de <a href...' tengo que limpiar todo hasta el A previo a castear como elemento "
        //         defaultValue = '<a' + defaultValue.split("<a").pop();

        //         var $tmp = $(defaultValue)
        //         if($tmp.hasClass('editable')){
        //             defaultValue = $tmp.html()
        //         }
