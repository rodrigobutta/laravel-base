...
class TreeMailer extends \App\Mailers\Mailer
{
    ...
    public function replyMail(User $to, User $from, Tree $on, $reply)
    {
        if ( ! $to->email_reply) {
            return;
        }
        ...
        $data = [
            ...
            'treeLink'         => route('tree', ['id' => $on->id, 'slug' => $on->slug]),
            'reply'             => $reply,
        ];
    ...
    public function favoriteMail(User $to, User $from, Tree $on)
    {
        ...
        $data = [
            ...
            'link'  => route('tree', ['id' => $on->id, 'slug' => $on->slug])
        ];
