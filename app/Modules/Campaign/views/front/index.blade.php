...
<div id="intranet_campaign_category" >
                ...
                @foreach($items as $p)
                    <div class="grid-item col-xs-12 col-sm-4 col-lg-3">
                        <a href="{{ $p->getLink() }}">
                            ...
                            <img src="{{ Resize::img($p->main_image, $p->receipts['campaignGridItem']) }}" />
                            <h3 class="campaign">{{ $p->campaign }}</h3>
...
@section('extra-js')
    ...
    <script>
        ...
        $(function(){
            ...
            $("#main_menu_campaign").addClass('active');
